<!-- TecnoVentas -->
	<li class="">
		...
		$sql=mysqli_query($mysqli_link,"select * from servicios where cliente=".$row["id"]." and servicio='tecnogestion'");
		//$canrow=
		?> <ul class="submenu">
						<!--Coloco esta opcion porque si no tiene opciones de daña
						Luego evaluare la forma de que el menu funcione-->
						<li class="">
